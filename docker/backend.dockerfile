...
# install R packages
RUN Rscript -e "Sys.setenv(MAKEFLAGS = '-j2'); install.packages(c('jsonlite', 'tidyverse', 'data.table', 'devtools', 'R.utils', 'aws.ec2metadata', 'cowplot', 'hrbrthemes', 'ggsci', 'ggrepel', 'svglite'), repos='https://cloud.r-project.org/')"
