        ...
        <div className="px-3 py-2" style={{minHeight: '500px'}}>
            ...
            }
            {
                ...
                (
                    <>
                        <p>
                            Two <a href="http://locuszoom.org/" target="_blank" rel="noreferrer">LocusZoom</a> plots below show the association <i>P</i>-values for QTLs (top panel), and GWAS (bottom panel). 
