  ...
  return async function (dispatch, getState) {
    ...
    try {
      ...
      if (res.data) {
        dispatch(
          updateQTLsGWAS({
            associationFile: form.get('associationFileName') || false,
            quantificationFile: form.get('quantificationFileName') || false,
            genotypeFile: form.get('genotypeFileName') || false,
            gwasFile: form.get('gwasFileName') || false,
            LDFile: form.get('LDFileName') || false,
          })
        );
      }
  ...
  return async function (dispatch, getState) {
    ...
    axios
      ...
      .catch(function ({ response }) {
        ...
        const msg = response.data.error.includes('VROOM')
...
export function submitLong(data) {
  return async function (dispatch, getState) {
    dispatch(
      updateQTLsGWAS({
        submitted: true,
    ...
    try {
      const response = await axios.post('api/submitLong', data);
      ...
      if (error) {
        dispatch(
          updateError({ visible: true, message: 'Job submission failed' })
        );
        dispatch(
          updateQTLsGWAS({
            isError: true,
